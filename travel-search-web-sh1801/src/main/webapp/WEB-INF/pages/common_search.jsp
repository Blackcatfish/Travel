...
<div class="tabs_content tabs1_content">
    <div id="tabs-1">
        <form action="<%=request.getContextPath()%>/search.html" class="form1" method="post" id="searchForm">
            <input id="pageNum" type="hidden" name="page">
            <div class="row">
    ...
    <div id="tabs-2">
        <form action="<%=request.getContextPath()%>/search.html" class="form1"  method="post">
